...
func Getusers(w http.ResponseWriter, r *http.Request) { //get the users of the site
	print("idem")
}
...
func Isregistered(w http.ResponseWriter, r *http.Request) bool { //is the user registered ?
	_, err := r.Cookie("uuid")
	if err != nil {
		user.Level = 0
		return false
